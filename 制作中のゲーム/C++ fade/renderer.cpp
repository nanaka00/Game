...
HRESULT CRenderer::Init(HWND hWnd, bool bWindow)
{
	...
	m_pD3DDevice->SetRenderState(D3DRS_SRCBLEND, D3DBLEND_SRCALPHA);		//ソース（描画元）
	...
	m_pD3DDevice->SetSamplerState(0, D3DSAMP_MINFILTER, D3DTADDRESS_WRAP);	//V値　繰り返し
